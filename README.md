...
|:--------------------:|:-----------------:|:-----------------:|
|LYRASENSE| <a href="https://lyrasense.com" target="_blank">Link</a> | Agentic AI platform for satellite data analysis with a notebook environment and Google Earth Engine integration. |
